    ...
    return [
      <div>
        ...
        <div>
          <div class="row">
            <div class="col-md-5">
              <cwc-video autoinit={true} poster="http://images.telvi.de/images/originals/2017/50/1/319b47392316aa2c54d5fbab.jpg"
                thumbnail={this.thumbnail} theme={this.theme}>
                <source src="http://techslides.com/demos/sample-videos/small.mp4" type='video/mp4' />
              </cwc-video>
            </div>
            <div class="col-md-5 offset-md-1">
              <cwc-video autoinit={false} poster="http://images.telvi.de/images/originals/2017/50/1/319b47392316aa2c54d5fbab.jpg"
                thumbnail={this.thumbnail} theme={this.theme}>
                <source src="http://techslides.com/demos/sample-videos/small.mp4" type='video/mp4' />
              </cwc-video>
            </div>
          ...
          <section class="box top">
            ...
            <marked-element><p>Element providing a wrapper around the Video.js HTML5 video library</p>
              ...
              <pre>
                <code>
                  &lt;cwc-video controls preload=<span class="hljs-string">"auto"</span> width=<span class="hljs-string">"640"</span> height=<span class="hljs-string">"264"</span> poster=<span class="hljs-string">"oceans-clip.png"</span>&gt;
